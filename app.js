...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var newProduct = multiply(multiply(a,b)[0], c)[0];
  var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + newSum + '.';
  var prodMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + newProduct + '.';
  return [newSum, newProduct, sumMessage, prodMessage];
...
var testArray = [2,3,4]; //eslint-disable-line
  ...
  function sumArray(testArray){ //eslint-disable-line
    var newSum = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
    var message = testArray + ' was passed in as an array of numbers, and ' + newSum + ' is their sum.';
    return [newSum, message];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var newProduct = multiply(multiply(testArray[0], testArray[1])[0], testArray[2])[0];
  var message = 'The numbers ' + testArray + ' have a product of ' + newProduct + '.';
